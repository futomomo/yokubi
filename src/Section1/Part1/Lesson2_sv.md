...
Som tidigare nämnt, så behöver japanskan inte skilja mellan singularis och pluralis. Utan explicit tillagda speciella pluraliserande ord, så kan bara sammanhanget säga dig om något är singularis eller pluralis. Ibland kan du, dock, vilja tydliggöra att du talar om något i pluralis. I detta fall, så kan du använda speciella suffix. Ett av dessa suffix är 達. Det kan appliceras på pronomen och substantiv och används för att referrera till en hel grupp som substantivet/pronomenet tillhör.

<pre>
私達・わたしたち Vi
ジム達・じむたち Jim och hans företag
ペン達・ぺんたち Pennan och annat
</pre>
...
<pre>
研究・けんきゅう forskning
研究者・けんきゅうしゃ forskare
</pre>

者, här uttalat しゃ, är ett suffix. Det kan aggera som en del i en sammansättning, men kan inte stå för sig själv som ett eget ord. När 者 dyker upp ensam i en mening, så är det ett annat ord, och inte uttalat しゃ. *Tack, kanji*.

Vissa ord kan läsas på mer än ett sätt. 明日, betyder "imorgon", är vanligtvis läst あした men kan också läsas あす (formellt, inte ovanligt) eller みょうにち (ännu mer formellt, mycket ovanligare). Se upp för läsningsvariationer när du börjar läsa, annars kommer du bli jätteförvirrad.
